...
def sample_pandas_df():
    ...
    return pd.DataFrame({
        ...
        'salary': [50000, 60000, 75000, 55000, 70000, 52000, 58000, 65000, 51000, 72000, 56000, 62000],
        'city': ['New York', 'London', 'Paris', 'Berlin', 'Tokyo', 'Sydney', 'Toronto', 'Mumbai', 'Moscow', 'Dubai', 'Singapore', 'Bangkok']
    })
